...
\begin{figure}[H]
  ...
  <<simplerega, echo=TRUE, results='asis', fig.width=5, fig.height=5>>=
  plot(y~x,ylim=c(40,120))
  @
  \caption{The input data \label{fig:test-a}}
  \end{subfigure}
  \begin{subfigure}{.5\textwidth}
  <<simpleregb, echo=TRUE, results='asis', fig.width=5, fig.height=5>>=
...
\par\vspace{0.4 cm}
\begin{figure}[H]
  <<simpleregc, echo=TRUE, results='asis', fig.width=5, fig.height=5>>=
